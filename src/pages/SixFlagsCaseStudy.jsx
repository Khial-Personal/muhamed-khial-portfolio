    ...
    <div className="cs">
      ...
      <section className="cs-section cs-hero">
        <div className="cs-container">
          ...
          <h1 className="cs-hero__title">
            <em>Six Flags <span style={{ color: '#000' }}>Qiddiya City</span></em>
          </h1>
          <p className="cs-hero__teaser">
            Designed the end-to-end booking flow for Six Flags at
      ...
      <section className="cs-section cs-prose">
        <div className="cs-container">
          ...
          <p>
            Six Flags is one of the flagship entertainment destinations
      ...
      <section className="cs-section cs-impact">
        <div className="cs-container">
          ...
          <p className="cs-lead">
            ...
            Six Flags digital product launch — a live, real-world
          ...
          <div className="cs-impact__links">
            <a
              ...
              href="https://sixflagsqiddiyacity.com/en"
              target="_blank"
            ...
            <a
              className="cs-impact__link"
              href="https://apps.apple.com/sa/app/six-flags-qiddiya-city/id6753164777"
              target="_blank"
              rel="noopener noreferrer"
            >
      ...
      <section className="cs-section cs-upnext">
        <div className="cs-container">
          ...
          <div className="cs-upnext__grid">
            <Link to="/work/aquarabia" className="cs-upnext__card">
              <span className="cs-upnext__year">2026</span>
              <h3>Aquarabia Qiddiya City</h3>
              <p>
                Booking flow for one of Saudi Arabia's most anticipated
...
export default SixFlagsCaseStudy
